...
const (
	...
	Greeter_SayHelloError_FullMethodName = "/helloworld.v1.Greeter/SayHelloError"
)
...
type GreeterClient interface {
	...
	SayHelloError(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *greeterClient) SayHelloError(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
type GreeterServer interface {
	...
	SayHelloError(context.Context, *HelloRequest) (*HelloReply, error)
...
func (UnimplementedGreeterServer) SayHelloError(context.Context, *HelloRequest) (*HelloReply, error) {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/server/v1/greeter.proto",
}
